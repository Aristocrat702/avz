...
class AIEngineerTab(tk.Frame):
    ...
    def build_ui(self):
        ttk.Label(self, text="AI-Инженер", font=("Segoe UI", 12, "bold")).pack(pady=10)
        ...
        ttk.Label(self, text="Что улучшить / исправить:").pack(anchor=tk.W, padx=5, pady=5)
        self.desc_entry = tk.Text(self, height=4)
        self.desc_entry.pack(fill=tk.X, padx=5)
        
        self.send_btn = ttk.Button(self, text="Отправить запрос", command=self.send_request)
